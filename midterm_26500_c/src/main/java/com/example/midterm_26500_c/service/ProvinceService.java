...
public class ProvinceService {
    ...
    public ProvinceResponse create(ProvinceRequest request) throws BadRequestException {
    ...
    public ProvinceResponse update(Long id, ProvinceRequest request) throws BadRequestException {
        Province province = provinceRepository.findById(id)
                .orElseThrow(() -> new NoSuchElementException("Province not found with id: " + id));
