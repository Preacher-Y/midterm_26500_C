...
public class VillageController {
    ...
    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody VillageRequest request) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable Long id, @Valid @RequestBody VillageRequest request) {
        try {
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        try {
            ...
            return ResponseEntity.ok(Map.of("message", "Village deleted successfully"));
        } catch (Exception e) {
            return handleException(e);
        }
    }
